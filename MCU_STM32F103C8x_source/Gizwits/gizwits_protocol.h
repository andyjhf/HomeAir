...
* @{
*/
#define PRODUCT_KEY "93aaf329803e4ce0982106675fb81bae"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f22baafb26b84018b6f97632d0ba8d52"
...
#define PM25_MIN                           0
#define PM25_MAX                           2000
#define TVOC_RATIO                         0.01
#define TVOC_ADDITION                      0
#define TVOC_MIN                           0
